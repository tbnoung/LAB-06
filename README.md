...
![](https://github.com/tbnoung/LAB-06/blob/master/6.1.PNG)

###คำถาม 6.1 ถ้าพิมพ์ตัวอักษรจำนวนหลายๆ ตัวแล้วกด Enter จะได้ผลอย่างไร ทำไมจึงเป็นเช่นนั้น

เพราะคำสั่ง Read() จะอ่านค่าได้ทีละคำ


###คำถาม 6.2 ในบรรทัดที่ 11 ซึ่งมีโปรแกรมเป็น ```ch = (char)Console.Read();```  นั้น ถ้าตัด ```(char)``` ออกไป จะเกิดอะไรขึ้น ให้อธิบายประกอบ
จะรันไม่ได้

เมื่อเราทำการตัด (char) จะทำError เพราะมันไม่รู้จักว่า ch=Console.Read(); คือตัวแปรอะไรที่จะต้องรับค่ามาอ่านแล้วต้องนำไปแสดงผล
...
![](https://github.com/tbnoung/LAB-06/blob/master/6.2.PNG)
...
![](https://github.com/tbnoung/LAB-06/blob/master/6.3.PNG)

###คำถาม 6.3 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร

การป้องกันสามมารถทำได้โดยใช้คำสั่ง Try Catch
...
![](https://github.com/tbnoung/LAB-06/blob/master/6.4.PNG)

###คำถาม 6.4 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น เหมือนหรือต่างจากโปรแกรมก่อนหน้านี้อย่างไร
![](https://github.com/tbnoung/LAB-06/blob/master/6.5.PNG)
...
![](https://github.com/tbnoung/LAB-06/blob/master/6.6.PNG)
